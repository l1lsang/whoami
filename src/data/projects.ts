...
export const projects: Project[] = [
  {
    ...
    status: 'Completed',
    githubUrl: 'https://github.com/USERNAME/dream-defenders',
    demoUrl: '',
    image: '/드림 디펜저스.png',
    accent: 'unity',
    challenges: [],
  ...
  },
  {
    ...
    status: 'MVP',
    githubUrl: 'https://github.com/USERNAME/spotit',
    demoUrl: 'https://spotit-example.vercel.app',
    image: '',
    accent: 'web',
    challenges: [],
    solutions: [],
  },
  {
    ...
    status: 'In Progress',
    githubUrl: 'https://github.com/USERNAME/hansung-space-reservation',
    demoUrl: '',
    image: '',
    accent: 'web',
    challenges: [],
  ...
  },
  {
    ...
    status: 'In Progress',
    githubUrl: 'https://github.com/USERNAME/discord-economy-bot',
    demoUrl: '',
    image: '',
    accent: 'bot',
    challenges: [],
