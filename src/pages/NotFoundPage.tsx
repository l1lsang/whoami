...
export function NotFoundPage() {
  return (
    <main
      id="main-content"
      tabIndex={-1}
      className="min-h-[calc(100svh-64px)] bg-canvas px-4 pb-20 pt-32 sm:px-8 sm:pt-40"
    >
      <div className="mx-auto max-w-7xl border-t border-ink/20 pt-4">
        <p className="font-mono text-[10px] uppercase tracking-[0.16em] text-web">
          404 / Not Found
        </p>
        <h1 className="mt-12 max-w-4xl font-display text-5xl font-medium leading-[1.04] tracking-[-0.05em] text-ink sm:text-7xl">
          페이지를 찾을 수 없습니다.
        </h1>
