...
export function ProjectDetailPage({ project }: ProjectDetailPageProps) {
  ...
  return (
    <main
      id="main-content"
      tabIndex={-1}
      className="detail-page bg-canvas pt-24"
    >
      <article>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-12 grid gap-10 lg:grid-cols-12 lg:gap-x-8">
              <div className="lg:col-span-8">
                <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.16em] text-web">
                  {project.category}
                </p>
              ...
              <div className="lg:col-span-3 lg:col-start-10 lg:self-end">
                <p className="font-display text-xl leading-8 tracking-[-0.02em] text-ink">
                  {project.subtitle}
                </p>
            ...
            >
              ...
              <ol className="mt-8 grid border-t border-ink/15 sm:grid-cols-2">
                {project.features.map((feature, index) => (
                  <li
                    key={feature}
                    className="grid min-h-16 grid-cols-[32px_1fr] items-start gap-3 border-b border-ink/15 py-4 text-sm leading-6 text-ink/80 sm:odd:pr-6 sm:even:border-l sm:even:pl-6"
                  >
                    <span className="font-mono text-[9px] text-unity">
              ...
              {hasRetrospective ? (
                <div className="mt-8 border-t border-ink/20">
                  {project.challenges.map((challenge, index) => (
                    <div
                      key={challenge}
                      className="grid gap-6 border-b border-ink/20 py-8 sm:grid-cols-2"
                    >
                      <div>
                      ...
                      <div className="border-l border-web pl-6">
                        <p className="font-mono text-[9px] uppercase tracking-[0.16em] text-web">
                          Solution
                        </p>
                        <p className="mt-3 text-sm leading-7 text-ink/80">
                ...
                <div className="mt-8 border-y border-ink/20 py-6 text-sm leading-7 text-muted">
                  추후 프로젝트 회고 내용을 추가할 예정입니다. 확인되지 않은
                  문제 해결 사례는 작성하지 않았습니다.
                </div>
              )}
            </section>
          </div>
            ...
            <div className="border-t border-ink/30 pt-4">
              ...
              <dl className="mt-6">
                <div className="border-b border-ink/15 py-5">
                  ...
                  <dd className="mt-2 text-sm font-medium text-web">
                    {project.status}
                  </dd>
                </div>
                <div className="border-b border-ink/15 py-5">
                  ...
                  <dd className="mt-2 text-sm leading-7 text-ink/80">
                    {project.role}
                  </dd>
                </div>
                <div className="border-b border-ink/15 py-5">
              ...
              <div className="mt-8 space-y-3">
                {project.githubUrl ? (
                  ...
                  >
                    <GitHubIcon aria-hidden="true" size={16} /> GitHub 보기{' '}
